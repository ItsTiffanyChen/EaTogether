...
//     </div>`;
//   johnIndex++;
// then print Mary's greeting message if not printed yet
// if (!isMaryPrinted) {
//   setTimeout(printMsg(() => {
//     chatArea.innerHTML +=
//       `<div>
...
// const prom = new Promise((resolve, reject, delay = 2000) => {
//   let time = 0;
//   let timer = setInterval(() => {
//     time += 1000;
//     if (time === 5000) {
...
// if user starts typing, Mary waits for 5 secs before replying


// const printM = printMsg(() => {
//   chatArea.innerHTML +=
//   `<div>
//     <p class="system-bubble">M</p>
//     <span>${maryMsg}</span>
